...
{
  "$end", "error", "$undefined", "INSTRUCTION", "SYMBOL", "CONSTANT",
  "$accept", "STMT", "INSTN", "LABEL", "SYM", YY_NULLPTR
};
#endif
...
#line 1239 "y.tab.c"
  ...
  case 4:
#line 37 "prg2.y"
    {printf("Instruction read: %s\n",(yyvsp[-1].string)); extract((yyvsp[-1].string)); line++;}
#line 1245 "y.tab.c"
    break;
